...
They're out of order: it goes high, then low, then medium, which doesn't really make sense
...
We would have to have to do it all maniually and enter in 50 abbreviations
...
#we added an argument to fct_reorder of ".desc=TRUE"
# And the corresponding output?
#...is now ordered by median repub percent, but descending (still starting from the bottom, though)
elections |> 
