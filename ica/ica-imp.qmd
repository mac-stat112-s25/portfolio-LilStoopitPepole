...
Associated values will be missing when something is absent, eg, when actor_3_name is NA, so is actor_3_facebook_likes. This might mean that in these cases, there literally aren't 3rd actors in these films. this includes 
